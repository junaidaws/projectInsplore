<?php include('header.php');?>
    ...
    <section class="aboutUs mt-4" data-aos="fade" data-aos-duration="1000" data-aos-delay="20">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="img__get_services"></div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="details__aboutUs">
                        <p>
                            <b>We provide all the GST services to the clients, but our core competencies include services like GSTR-1, GSTR-2, GSTR-3B, GSTR-9.</b>
                        </p>
