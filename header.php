...
<head>
    ...
    <title>Acontax Consultancy</title>
...
<body>
    <header class="headWrapper">
        <div class="top__headWrapper pdTop2">
            <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link  dropdown-toggle" data-aos="zoom-in-down" href="javascript:void(0);" data-toggle="dropdown">  Our Team  </a>
                                    <ul class="dropdown-menu fade-up">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link  dropdown-toggle" data-aos="zoom-in-down" href="javascript:void(0);" data-toggle="dropdown">  Digital Marketing  </a>
                                    <ul class="dropdown-menu fade-up">
